                        ...
                        <TableRow>
                            <TableCell colSpan="3">
                                <Table id="advanced-table">
                                    ...
                                    <TableRow><TableCell>Base URL</TableCell><TableCell><TextInput placeholder='type here' value={"http://localhost:3000"} /></TableCell></TableRow>
                                    <TableRow><TableCell border={"top"} colSpan={"4"} /></TableRow>
                                    <TableRow><TableCell >API Hostname</TableCell><TableCell ><TextInput placeholder='type here' value={"localhost"} /></TableCell><TableCell><Button color={'var(--color-button-border)'} disabled={false} width={'medium'} round={'large'} active={true} label={'ping host'} onClick={testDatabase} /></TableCell></TableRow>
                                    <TableRow><TableCell>API Port</TableCell><TableCell><TextInput placeholder='type here' value={"3000"} /></TableCell><TableCell><Button color={'var(--color-button-border)'} disabled={false} width={'medium'} round={'large'} active={true} label={'open port'} onClick={testDatabase} /></TableCell></TableRow>
                                    ...
                                    <TableRow><TableCell border={"top"} colSpan={"4"} /></TableRow>
                                    <TableRow><TableCell >Database Hostname</TableCell><TableCell><TextInput value={"localhost"} /></TableCell><TableCell><Button color={'var(--color-button-border)'} disabled={false} width={'medium'} round={'large'} active={true} label={'ping host'} onClick={testDatabase} /></TableCell></TableRow>
                                    <TableRow><TableCell>Database Port</TableCell><TableCell><TextInput placeholder='type here' value={"3000"} /></TableCell><TableCell><Button color={'var(--color-button-border)'} disabled={false} width={'medium'} round={'large'} active={true} label={'open port'} onClick={testDatabase} /></TableCell></TableRow>
                                    <TableRow><TableCell>Database Name</TableCell><TableCell><TextInput placeholder='type here' value={"bubbles"} /></TableCell></TableRow>
                                    <TableRow><TableCell>Database Username</TableCell><TableCell><TextInput placeholder='type here' value={"bubbles"} /></TableCell></TableRow>
                                    <TableRow><TableCell>Database Password</TableCell><TableCell><TextInput placeholder='type here' value={"bubbles"} /></TableCell></TableRow>
