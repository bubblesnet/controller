...
function RenderSwitchPanel (props) {
    ...
    let ret =
        ...
        <RenderDeviceSwitch exists={props.state.station_settings.light_vegetative||props.state.station_settings.light_bloom||props.state.station_settings.light_germinate}
                            toggle={props.switchControl.currentGrowLight.toggle} on="ON" off="OFF" onOff={props.state.switch_state.currentGrowLight.on?"ON":"OFF"} label='Current Grow Light' automaticControl={value_name} changing={props.state.switch_state.automaticControl.changing}/>
