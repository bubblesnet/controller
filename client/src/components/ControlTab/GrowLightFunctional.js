            ...
            ret =
                <div className="growlight-container-off">
                    ...
                    <div id="humidity-holder" >
                        <RenderHygrometer exists={state.cabinet_settings.humidity_sensor} currentHumidity={state.status.humidity} units={state.display_settings.humidity_units} direction={state.status.humidity_internal_direction}/>
                    </div>
                </div>
        } else {
            ret =
