...
exports.getLastKnownIPAddress = function (userid, deviceid, cb) {
    ...
    return pool.query("select * from currentevent where userid_user = ? AND deviceid_device = ? AND type = 'SYSTEM_START' and stringvalue <> 'null' order by datetimemillis desc LIMIT 1", [userid, deviceid], function (err, eventresult) {
