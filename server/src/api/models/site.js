...
async function getSiteById(siteid) {
    const results = await db.query(
        sql`
            SELECT sitename as site_name, siteid_site as siteid, station_name, location, stationid, current_stage, controller_hostname, controller_api_port, stage, light_on_hour, tamper_xmove, tamper_ymove, tamper_zmove,
