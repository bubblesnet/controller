CREATE OR REPLACE FUNCTION public."InitializeVOCCO2Sensors2"()
    RETURNS integer
    LANGUAGE 'plpgsql'
    COST 100
    VOLATILE
...
VALUES ('CO2/VOC sensor',60000007,'sense-go','ccs811','0x5a', 'i2c') RETURNING moduleid into new_moduleid;
...
SELECT public."InitializeVOCCO2Sensors2"();